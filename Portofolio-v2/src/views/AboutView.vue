  ...
  data() {
    return {
      ...
      tech: [
        ...
        //   id: 6,
        //   name: 'Codeigniter',
        //   imageUrl: 'https://e7.pngegg.com/pngimages/513/866/png-clipart-codeigniter-logo-code-igniter-logo-icons-logos-emojis-tech-companies.png',
        //   status: 'Intermediate'
        // },
        {
          id: 7,
      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-9/12 rounded-full mb-3 fadein-up"
            src="../../public/img/avatar-linkedin.jpeg" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Nguyen Minh Tuan. I'm a web developer from Bogor, West Java. I
